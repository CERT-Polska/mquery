...
class SearchJobRow extends Component {
    ...
    render() {
        ...
        switch (this.props.status) {
            ...
            case "processing": rowClass = "table-info"; break;
            case "querying": rowClass = "table-info"; break;
            case "cancelled": rowClass = "table-danger"; break;
            default: rowClass = ""; break;
        }

        let status = this.props.status;
        let cancelBtn = <button className="btn btn-sm btn-danger" onClick={this.handleCancelJob}>cancel</button>;
