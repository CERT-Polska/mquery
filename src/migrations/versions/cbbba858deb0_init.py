...
def upgrade() -> None:
    ...
    sa.Column('rule_author', sqlmodel.sql.sqltypes.AutoString(), nullable=False),
    sa.Column('raw_yara', sqlmodel.sql.sqltypes.AutoString(), nullable=False),
    ...
    sa.ForeignKeyConstraint(['job_id'], ['job.internal_id'], ),
    sa.PrimaryKeyConstraint('id')
    )
